"""
Django settings for bm_portal project.
...
SECRET_KEY = 'django-insecure-2y*q#(*^76e18awn)m&qywtvi%z=!1&99@80r@iz(7)ar_ee()'
...
WSGI_APPLICATION = 'bm_portal.wsgi.application'
